...
At [GearShift](http://gearshift.es), we got a generous AWS package that lets us use some of their services for free\. The problem is… I had no experience whatsoever with AWS and their UI is a nightmare \(totally a subjective opinion\) \. So… how did I do this thing?
...
#### 1\. Head on to [eu-central-1.console.aws.amazon.com/ec2](https://eu-central-1.console.aws.amazon.com/ec2)
