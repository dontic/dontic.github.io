...
1. Pagar y pasar la ITV ese día (suelen ser unos 100€ - 150€ dependiendo de la ITV).

2. Obtener ficha técnica Española.

## 6. Impuesto de transmisiones patrimoniales (ITP - Modelo 620)

> ℹ️ Si el coche es de **segunda mano (>6 meses o >6.000 km) y se lo has comprado a un profesional**, no tienes que pagar ITP y **puedes saltarte este paso**.
