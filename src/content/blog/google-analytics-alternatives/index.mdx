...
[Swetrix](https://github.com/Swetrix/swetrix) has also a great UI:
...
[Vince](https://github.com/vinceanalytics/vince) is the first Google Analytics alternative I've used. It's made by a solo dev:
...
[Pausible](https://github.com/plausible/analytics) is one of the more mature, well known and big projects in this list.
...
[GoatCounter](https://github.com/arp242/goatcounter) has a super straightforward and kind of "old school" UI:
...
[Matomo](https://github.com/matomo-org/matomo) has become SUPER popular in the last few years and it's really active in the community.
...
[Fathom](https://github.com/usefathom/fathom) is another great project, but their self hosted version is quite lacking compared to the other ones. It also hasn't been updated in 2 years.

## References

- <a
    href="https://aaronjbecker.com/posts/umami-vs-plausible-vs-matomo-self-hosted-analytics/"
