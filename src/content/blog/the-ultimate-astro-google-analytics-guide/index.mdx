...
_Many people have asked me to do a [full course on how to build and deploy a full stack app from scratch](/blog/im-building-a-course/)._

_If you're interested feel free to join the waitlist and I'll let you know when it's out!_
...
**You probably do not need Google Analytics.**
...
If better UI, simpler setup, same (or even more) data, self hosted and no cookie banner sounds good to you, you should probably read that article first.
