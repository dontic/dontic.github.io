...
I've previously wrote an article on [how to centralize and easily query logs with Promtail + Loki + Grafana](/blog/how-to-centralize-and-visualize-your-app-logs-in-grafana/).

In this article I will focus on the querying part. How we're doing it for [Estavia](https://estavia.ai) and how to properly query logs in Grafana and how to parse your log format to easily filter the lines you want to see.
