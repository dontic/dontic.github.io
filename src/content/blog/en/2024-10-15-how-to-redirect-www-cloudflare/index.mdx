...
If you want to learn more about this you can check [developers.cloudflare.com/dns/manage-dns-records/reference/proxied-dns-records/](https://developers.cloudflare.com/dns/manage-dns-records/reference/proxied-dns-records/)
