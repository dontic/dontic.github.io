...
- [Django Migrations](https://docs.djangoproject.com/en/5.1/topics/migrations/#squashing-migrations)
- [Squashing Django Migrations the Easy Way](https://jacklinke.com/squashing-django-migrations-the-easy-way)
